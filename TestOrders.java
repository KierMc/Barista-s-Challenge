...
public class TestOrders {
    public static void main(String[] args) {
        ...
        // Menu items
        Item item1 = new Item("cappucino", 5.99);
        Item item2 = new Item("Mocha", 6.49);
        Item item3 = new Item("Latte", 4.44);
        Item item4 = new Item("Coffee", 5.01);
